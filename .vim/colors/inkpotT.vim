...
if has("gui_running")
    ...
    "here
    hi Identifier     gui=NONE   guifg=#f0ad6d   guibg=NONE
    hi Ignore         gui=NONE
    ...
    "here
    hi Type           gui=NONE   guifg=#f0ad6d   guibg=NONE
    ...
    " ctermfg=" . <SID>X(79)
        ...
        exec "hi Normal         cterm=NONE   ctermfg=" . "NONE" . " ctermbg=" . <SID>X(16)
    endif
    ...
    "here
    exec "hi Type           cterm=NONE   ctermfg=" . <SID>X(39) . " ctermbg=" . "NONE"
